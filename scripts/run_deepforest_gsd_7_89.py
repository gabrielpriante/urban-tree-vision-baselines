...
# Define a separate output directory for the 7.89 cm/pixel experiment so these predictions cannot overwrite the native-resolution baseline.
output_dir = Path("outputs/experiment_001/deepforest/gsd_7.89") / condition
